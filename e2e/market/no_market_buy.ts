import { deserializeDatum, mConStr0, mConStr1, mConStr2, mConStr3, mPubKeyAddress } from "@meshsdk/core";
...
// NoMarketBuy
const MarketExecution = mConStr3([noAmount, mPubKeyAddress(wallet1VK, wallet1SK)]);
...
const unsignedTx = await txBuilder
    ...
    // send user "No" tokens
    .txOut(wallet1Address, [{ unit: tokenUnit, quantity: String(noAmount) }])

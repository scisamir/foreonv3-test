...
// YesMarketBuy
const MarketExecution = mConStr2([yesAmount, mPubKeyAddress(wallet1VK, wallet1SK)]);
...
console.log("marketUtxo:", marketUtxo);
...
const unsignedTx = await txBuilder
    ...
    .txOut(wallet1Address, [{ unit: tokenUnit, quantity: String(yesAmount) }])
